...
void isolation(const char* name) {
	...
	d1=d1.Define("goodtriggerpt",goodtrigger,{"goodgenpt","goodgeneta","goodgenphi","Muon_eta","Muon_phi","Muon_isGlobal","Muon_pt","Muon_standalonePt","Muon_standaloneEta","Muon_standalonePhi","Muon_isStandalone","Muon_mediumId","Muon_dxybs","isTriggeredMuon"}).Define("goodtriggereta",goodtrigger,{"goodgeneta","goodgeneta","goodgenphi","Muon_eta","Muon_phi","Muon_isGlobal","Muon_pt","Muon_standalonePt","Muon_standaloneEta","Muon_standalonePhi","Muon_isStandalone","Muon_mediumId","Muon_dxybs","isTriggeredMuon"}).Define("goodtriggerphi",goodtrigger,{"goodgenphi","goodgeneta","goodgenphi","Muon_eta","Muon_phi","Muon_isGlobal","Muon_pt","Muon_standalonePt","Muon_standaloneEta","Muon_standalonePhi","Muon_isStandalone","Muon_mediumId","Muon_dxybs","isTriggeredMuon"}).Define("goodtriggeridx",goodtriggeridx,{"goodgeneta","goodgenphi","Muon_eta","Muon_phi","Muon_isGlobal","Muon_pt","Muon_standalonePt","Muon_standaloneEta","Muon_standalonePhi","Muon_isStandalone","Muon_mediumId","Muon_dxybs","isTriggeredMuon"});
	d1=d1.Define("goodtrigger",goodstand,{"goodtriggeridx","isTrigIso","Muon_pt","Muon_standalonePt"});
	...
	TFile* output=new TFile("outputiso.root","RECREATE");
	output->cd();
