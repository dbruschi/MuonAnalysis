...
void isolation(const char* name) {
	...
	d1=d1.Define("goodglobalpt",goodmuon,{"goodgenpt","goodgeneta","goodgenphi","Muon_standeta","Muon_standphi","Muon_isGlobal"}).Define("goodglobaleta",goodmuon,{"goodgeneta","goodgeneta","goodgenphi","Muon_standeta","Muon_standphi","Muon_isGlobal"}).Define("goodglobalphi",goodmuon,{"goodgenphi","goodgeneta","goodgenphi","Muon_standeta","Muon_standphi","Muon_isGlobal"}).Define("goodglobalidx",goodmuonidx,{"goodgeneta","goodgenphi","Muon_standeta","Muon_standphi","Muon_isGlobal"});
	d1=d1.Define("goodglobal",goodglobal,{"goodglobalidx","Muon_mediumId","Muon_dxyBS"});
	d1=d1.Define("goodidippt",goodidip,{"goodgenpt","goodgeneta","goodgenphi","Muon_standeta","Muon_standphi","Muon_isStandalone","Muon_isGlobal","Muon_mediumId","Muon_dxyBS"}).Define("goodidipeta",goodidip,{"goodgeneta","goodgeneta","goodgenphi","Muon_standeta","Muon_standphi","Muon_isStandalone","Muon_isGlobal","Muon_mediumId","Muon_dxyBS"}).Define("goodidipphi",goodidip,{"goodgenphi","goodgeneta","goodgenphi","Muon_standeta","Muon_standphi","Muon_isStandalone","Muon_isGlobal","Muon_mediumId","Muon_dxyBS"}).Define("goodidipidx",goodidipidx,{"goodgeneta","goodgenphi","Muon_standeta","Muon_standphi","Muon_isStandalone","Muon_isGlobal","Muon_mediumId","Muon_dxyBS"});
	d1=d1.Define("goodidip",goodstand,{"goodidipidx","Muon_triggered"});
	d1=d1.Define("goodtriggerpt",goodtrigger,{"goodgenpt","goodgeneta","goodgenphi","Muon_standeta","Muon_standphi","Muon_isStandalone","Muon_isGlobal","Muon_mediumId","Muon_dxyBS","Muon_triggered"}).Define("goodtriggereta",goodtrigger,{"goodgeneta","goodgeneta","goodgenphi","Muon_standeta","Muon_standphi","Muon_isStandalone","Muon_isGlobal","Muon_mediumId","Muon_dxyBS","Muon_triggered"}).Define("goodtriggerphi",goodtrigger,{"goodgenphi","goodgeneta","goodgenphi","Muon_standeta","Muon_standphi","Muon_isStandalone","Muon_isGlobal","Muon_mediumId","Muon_dxyBS","Muon_triggered"}).Define("goodtriggeridx",goodtriggeridx,{"goodgeneta","goodgenphi","Muon_standeta","Muon_standphi","Muon_isStandalone","Muon_isGlobal","Muon_mediumId","Muon_dxyBS","Muon_triggered"});
	d1=d1.Define("goodtrigger",isgoodtrigger,{"goodtriggeridx","Muon_pfRelIso04_all"});
	...
	auto histo11 = d1.Histo2D({"histo11", "", 48, -2.4, 2.4, 9, 25., 60.}, "goodtriggereta", "goodtriggerpt", "goodtrigger");
	auto histo12 = d1.Histo2D({"histo12", "", 48, -2.4, 2.4, 9, 25., 60.}, "goodtriggereta", "goodtriggerpt");
	...
	c1->cd();
	c1->Draw();
	Histo1->SetTitle("P(global&&IDIP&&trigger match&&pfRelIso<0.15|gen)");
	...
	c3->cd();
	c3->Draw();
	product->SetTitle("P(pfRelIso<0.15)*P(trigger|idip)*P(idip|global)*P(global|standalone)*P(standalone|tracker seeded)");
